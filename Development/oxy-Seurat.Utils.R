...
#' @param n.datasets PARAM_DESCRIPTION, Default: length(ls.Seurat)
...
# recall.genes.ls ------------------------------------------------------------------------
#' @title recall.genes.l
#' @description genes.ls #
#' @param obj Seurat object, Default: combined.obj
#' @examples
#' \dontrun{
#' if(interactive()){
...
m3.get.umap <- function(obj = cds_from_seurat, slot = 'UMAP', dim = (2:3)[2]) {
  ...
  stopif(condition = is_null(df.reduction), message = paste('slot not found', slot))
...
#' @description
#' @param feature1 PARAM_DESCRIPTION, Default: 'M.RabV.N2c'
#' @param feature2 PARAM_DESCRIPTION, Default: 'P.RabV.N2c'
#' @param obj Seurat object, Default: combined.obj
#' @param ext PARAM_DESCRIPTION, Default: 'png'
...
#' @description
#' @param gene gene of interest, Default: 'N.RabV.N2c'
#' @param obj Seurat object, Default: combined.obj
...
#' \dontrun{
#' if(interactive()){
#'  FindCorrelatedGenes(gene ="N.RabV.N2c", obj = combined.obj); write_clip(names(head(topGenes[-(1:6)], n=50)))
#'  }
#' }
#' @seealso
