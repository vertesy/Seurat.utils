...
## List of Functions in Seurat.Utils.R (84) 

Updated: 2023/11/27 18:18
...
- #### 5 `calc.q99.Expression.and.set.all.genes()`
...
- #### 29 `remove_clusters_and_drop_levels()`
...
- #### 62 `HGNC.EnforceUnique()`

  HGNC.EnforceUnique. Enforce Unique names after HGNC symbol update. While "make.unique" is not the ideal  solution, because it generates mismatches, in my integration example it does reduce the  mismatching genes from ~800 to 4
...
- #### 84 `regress_out_and_recalculate_seurat()`
...
## List of Functions in Seurat.Utils.Visualization.R (42) 
...
- #### 33 `ww.check.if.3D.reduction.exist()`

  ww.check.if.3D.reduction.exist. ww.check.if.3D.reduction.exist in backup slot #

- #### 34 `ww.check.quantile.cutoff.and.clip.outliers()`
...
- #### 39 `SetupReductionsNtoKdimensions()`
...
-----------
[Get Seurat.utils](https://github.com/vertesy/Seurat.utils). Vertesy, 2023. [![DOI](https://zenodo.org/badge/248721133.svg)](https://zenodo.org/badge/latestdoi/248721133) 
